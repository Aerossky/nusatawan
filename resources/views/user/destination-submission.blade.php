        ...
        <div class="bg-white rounded-lg shadow-lg p-6">
            <form action="{{ route('destination-submission.store') }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-6">
                        <div>
                            <label for="place_name" class="block text-sm font-medium text-gray-700 mb-1">Nama Tempat</label>
                        ...
                        <div>
                            <label for="time_minutes" class="block text-sm font-medium text-gray-700 mb-1">Waktu Kunjungan
                                (Menit)</label>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Foto Destinasi (Maksimal 5
                                foto)</label>
                            <div
