                    ...
                    <form action="{{ route('destination-submission.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1" for="images">Foto Destinasi (Maksimal 5
                                        foto)</label>
                                    <div
                            ...
                            <div class="space-y-6">
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1" for="map">Lokasi di Peta</label>
