...
<body class="h-screen w-screen flex items-center justify-center bg-gray-100">
    ...
    <div
        class="w-full max-w-4xl h-screen md:h-[500px] flex flex-col md:flex-row bg-white shadow-lg rounded-lg overflow-hidden relative">
        ...
        <!-- Form Login (di tengah layar saat mobile) -->
        <div
            ...
            <div class="w-full max-w-md bg-white  p-6 rounded-lg shadow-lg md:shadow-none">
                <h2 class="text-2xl font-semibold text-gray-700 text-center">Halo,
                    <span class="text-primary font-bold">Nusatawan</span>
                </h2>
                <p class="text-center text-gray-500 mb-6">Masukkan email dan kata sandi anda.</p>
                ...
                <p class="text-center text-gray-500 mt-4">
                    Belum punya akun? <a href="#" class="text-primary font-semibold hover:underline">Ayo
                        Daftar</a>
                </p>
            </div>
        </div>
