    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white">
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href=""
                    class="flex items-center p-2 rounded-lg transition group
                    {{ request()->routeIs('admin.settings.*') ? 'bg-gray-100 text-blue-600' : 'text-gray-900 hover:bg-gray-100' }}">
                    <svg class="w-5 h-5 {{ request()->routeIs('admin.settings.*') ? 'text-blue-600' : 'text-gray-500 group-hover:text-gray-900' }}"
                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                        <path
